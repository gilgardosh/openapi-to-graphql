...
describe('GraphQL Extensions', () => {
  // NOTE: The new implementation doesn't handle x-graphql-... extensions
  ...
  //   beforeAll(async () => {
  //     const oasStr = readFileSync(join(__dirname, './fixtures/extensions.json'), 'utf8');
  //     oas = JSON.parse(oasStr);
